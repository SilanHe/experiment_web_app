...
function sanityCheck(gammaRed, gammaGreen, gammaBlue, numSets, sampleSize,
  normalizeContrast) {
  const choice = CHOICE.HILL;
  const materials = Object.entries(MATERIALS);
  const averageGammaFactor = (gammaRed + gammaGreen + gammaBlue) / 3;
...
// getContrastData(1, 1, 1, 1, 100, false, 60, MATERIALS.GLOSSY);
getSet(1, 2.4, 2.4, 2.4, 1, true);
// sanityCheck(1, 1, 1, 1, 5, true);
